...
{
    public class MasterAssetCategory
    {
        [Key]
        ...
        [Remote(action: "CheckIfExists", controller: "Asset_Category_Master", AdditionalFields = "Id")]
        public string Code { get; set; }

        [Required(AllowEmptyStrings = false, ErrorMessage = "The Name field is required.")]
        public string Name { get; set; }

        [Required(AllowEmptyStrings = false, ErrorMessage = "The Utilize Life field is required.")]
        public string UtilizeL { get; set; }

        [Required(AllowEmptyStrings = false, ErrorMessage = "The Code Format field is required.")]
